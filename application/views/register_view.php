<div id="register" class="animate form">
                            ...
                            <form  action="" autocomplete="on" method="POST"> 
                                ...
                                <p> 
                                    ...
                                    <input id="usernamesignup" name="usernamesignup" required="required" type="text" placeholder="mysuperusername690" value="<?php if (isset($data)) echo $data->get_login() ?>" />
                                </p>
                                <p> 
                                    <label for="emailsignup" class="youmail" data-icon="e" ><?php  echo($t['Your email']); ?> </label>
                                    <input id="emailsignup" name="emailsignup" required="required" type="email" placeholder="mysupermail@mail.com" value="<?php if (isset($data)) echo $data->get_email() ?>" /> 
                                </p>
                                <p> 
